...
import { PencilSquareIcon, FolderOpenIcon } from '@heroicons/react/20/solid';
    ...
    <div className='grid grid-cols[1fr_1fr] w-64 h-screen bg-background border-r'>
      ...
      <ScrollArea className='h-[calc(100vh-100px)]'>
        {courses && courses.length > 0 ? (
          ...
          <div className='relative border border-input rounded-lg grid place-items-center py-4 mx-2'>
            <div className='flex flex-col gap-2 items-center'>
              <FolderOpenIcon className='w-6 h-6' />
              <p className='text-xs'>You have no courses</p>
            </div>
          </div>
        )}
      </ScrollArea>
