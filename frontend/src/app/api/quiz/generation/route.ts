...
export async function POST(req: NextRequest) {
  ...
  const distributeQuestions = async (numQuestions: number, formats: string[], subject: string, topic: string): Promise<Record<string, {numQuestions: number, topics: string[]}>> => {
