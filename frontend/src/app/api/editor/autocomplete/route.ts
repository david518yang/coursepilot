...
const PROMPT =
  "Complete the following sentence, and return only the text missing from the current prefix. If the content seems already complete, return the empty string. Otherwise, make an attempt. The current prefix is: ";
